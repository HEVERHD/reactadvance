...
export const Card = ({ title, id, overview, poster_path, props }) => {
  ...
  return (
    <div className="card-group col-xs-12 col-sm-6 col-md-4 col-lg-3 animate__animated animate__pulse">
      <div className="card my-3">
        <h5 className="card-title text-center">
          <b>{title.substring(0, 25)}...</b>
        </h5>
        <img
