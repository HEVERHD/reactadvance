...
export const Resultado = () => {
  ...
  useEffect(()=>{
    const enPoint = 
    `https://api.themoviedb.org/3/search/movie?api_key=eb42fd1735381027e43257fb869cd9ad&language=en-US&query=${keyword}`;
    axios
      .get(enPoint)
      .then((res) => {
  ...
  return (
    <>
    <h2>Resultados encontrados : <em>{keyword}</em></h2>
